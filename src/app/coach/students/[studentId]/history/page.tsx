...
export default function CoachStudentHistoryPage() {
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-background">
        <PageHeader title="Historial" backHref={`/coach/students/${studentId}`} />
  ...
  return (
    <div className="min-h-screen bg-background pb-24">
      <PageHeader
        title={`Historial - ${studentName}`}
        subtitle={
          viewMode === "progress"
            ? "Analiza el progreso por ejercicio"
                  ...
                  <CardContent className="p-4">
                    <div className="flex items-center justify-between mb-4">
                      ...
                      <span className="text-xs text-text-muted">
                        Últimas {Math.min(10, selectedExerciseData.length)} de{" "}
                        {selectedExerciseData.length}
                      </span>
                    </div>
              ...
              <Card className="bg-surface/80 border-border">
                <CardContent className="p-8 text-center">
                  ...
                  <p className="text-text-muted text-sm">
                    Elige un ejercicio para ver el progreso del alumno
                  </p>
                </CardContent>
              </Card>
            )}
                ...
                {groupedHistory.map((meso, mesoIndex) => (
                  ...
                  >
                    ...
                    <div className="space-y-3 ml-2 border-l-2 border-accent/30 pl-4">
                      {meso.micros.map((micro, microIndex) => {
