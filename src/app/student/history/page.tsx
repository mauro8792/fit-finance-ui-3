                        ...
                        <tbody>
                          {exercise.sets.map((set, setIndex) => (
                            <React.Fragment key={`set-${setIndex}`}>
                              ...
                              {/* Isohold details */}
                              {set.isIsohold && (
                                <tr key={`iso-${setIndex}`} className="bg-cyan-500/10 border-b border-cyan-500/20">
                                  <td className="py-1 px-2 text-[10px] text-cyan-400 pl-6">
                                    ↳ Iso
                                  </td>
                                  <td colSpan={4} className="py-1 px-2 text-[11px] text-cyan-300">
